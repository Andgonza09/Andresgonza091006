    ...
    internal class Program
    {
        static void preciosDólares(double[] preciosCórdobas)
        {
            ...
            for (int i = 0; i < preciosCórdobas.Length; i++)
            {
                ...
                double precioDolares = preciosCórdobas[i] / tasaCambio;
                
                Console.WriteLine($"El precio en dólares del artículo {i + 1} es: {precioDolares:F2}");
            }

            // Almacenamos los precios en dólares en un nuevo array usando LINQ
        ...
        static void Main(string[] args)
        {
            ...
            // Solicitá al usuario que ingrese una cantidad determinada de precios en córdobas 
